...
// NOTE: THESE VALUES NEED TO BE CHANGED LATER
...
signed char	toI2C_sendmsg(unsigned char,unsigned char,void *);
signed char	toI2C_recvmsg(unsigned char,unsigned char *,void *);
