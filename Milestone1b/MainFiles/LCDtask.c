...
static portTASK_FUNCTION( vLCDUpdateTask, pvParameters )
{
	...
	{	
		...
		if (i > 79)
		{
			...
			//sprintf((char *)toprint, "%2.2fmA", max);
			//GLCD_DisplayString(0,11,1, (unsigned char*)&toprint);
			sprintf((char *)toprint, "%2.2fmA", avg);
			GLCD_DisplayString(9,11,1, (unsigned char*)&toprint);
